...
/**
*
* @description 反射泛型类型工具类 (例如：ObjectClass<String,Integer>，String为索引0，Integer为索引1)
* @author YangXiang
* @time 2018/11/22 17:15
*
*/
public class ReflectGeneric {
	 ...
	 * @return
	 */
	public static String getSQLCloum(Field field, String name) {
	 ...
	 * @return
	 */
	public static String getSQLCloum(Class<?> clazz, String name) {
		return getSQLCloum(getField(clazz, name), name);
	}
