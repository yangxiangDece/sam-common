...
public class RandomUtil {
     ...
     * 返回随机产生的手机号码
     *
     * @param isHide 是否隐藏中间4位为<code>****</code>
     * @return
     */
    public static String randomTel(boolean isHide) {
        int index = randomNumRange(0, TEL_FIRST_ARR.length - 1);
        String first = TEL_FIRST_ARR[index];
        String second = isHide ? "****" : String.valueOf(randomNumRange(1, 888) + 10000).substring(1);
